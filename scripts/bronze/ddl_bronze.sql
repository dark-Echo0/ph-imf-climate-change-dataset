...
-- Create 'bronze.ghg_investment_related' table
IF OBJECT_ID('bronze.ghg_investment_related', 'U') IS NOT NUll
	DROP TABLE bronze.ghg_investment_related; 
GO
  
CREATE TABLE bronze.ghg_investment_related(
  country NVARCHAR(MAX),	iso2 NVARCHAR(MAX),	iso3 NVARCHAR(MAX),	indicator_used NVARCHAR(MAX), 
