...
Country NVARCHAR(MAX), ISO2 NVARCHAR(MAX), ISO3 NVARCHAR(MAX),
Indicator NVARCHAR(MAX),	Unit NVARCHAR(MAX), Source NVARCHAR(MAX),
CTS_Code NVARCHAR(MAX),	CTS_Name NVARCHAR(MAX), 	CTS_Full_Descriptor NVARCHAR(MAX),
Industry NVARCHAR(MAX),	Gas_Type NVARCHAR(MAX), 	Scale NVARCHAR(MAX), 	
