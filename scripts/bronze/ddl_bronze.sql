...
CREATE TABLE bronze.ghg_co2_emissions(
  country NVARCHAR(15),	iso2 NVARCHAR(10),	iso3 NVARCHAR(10),	indicator_used NVARCHAR(50),
  unit NVARCHAR(50),	source NVARCHAR(MAX),	cts_code NVARCHAR(15),	cts_name NVARCHAR(50),
  cts_full_descriptor	NVARCHAR(MAX), industry NVARCHAR(MAX),	scale NVARCHAR(10),
